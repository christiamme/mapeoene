...
describe.cam = "<h1>Campeche</h1><br /><div id='cam'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.chis = "<h1>Chiapas</h1><br /><div id='chis'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.chi = "<h1>Chihuahua</h1><br /><div id='chi'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.coa = "<h1>Coahuila</h1><br /><div id='coa'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.col = "<h1>Colima</h1><br /><div id='col'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.cdmx = "<h1>Ciudad de México</h1><br /><div id='cdmx'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.dur = "<h1>Durango</h1><br /><div id='dur'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.gua = "<h1>Guanajuato</h1><br /><div id='gua'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.gro = "<h1>Guerrero</h1><br /><div id='gro'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.hid = "<h1>Hidalgo</h1><br /><div id='hid'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.jal = "<h1>Jalisco</h1><br /><div id='jal'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.mex = "<h1>México</h1><br /><div id='mex'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.mich = "<h1>Michoacán</h1><br /><div id='mich'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.mor = "<h1>Morelos</h1><br /><div id='mor'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.nay = "<h1>Nayarit</h1><br /><div id='nay'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.nl = "<h1>Nuevo León</h1><br /><div id='nl'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.oax = "<h1>Oaxaca</h1><br /><div id='oax'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.pue = "<h1>Puebla</h1><br /><div id='pue'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.qro = "<h1>Querétaro</h1><br /><div id='qro'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.qr = "<h1>Quintana Roo</h1><br /><div id='qr'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.slp = "<h1>San Luis Potosí</h1><br /><div id='slp'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.sin = "<h1>Sinaloa</h1><br /><div id='sin'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.son = "<h1>Sonora</h1><br /><div id='son'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.tab = "<h1>Tabasco</h1><br /><div id='tab'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.tam = "<h1>Tamaulipas</h1><br /><div id='tam'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.tla = "<h1>Tlaxcala</h1><br /><div id='tla'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.ver = "<h1>Veracruz</h1><br /><div id='ver'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.yuc = "<h1>Yucatán</h1><br /><div id='yuc'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";
describe.zac = "<h1>Zacatecas</h1><br /><div id='zac'><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p></div>";

window.JSMaps.maps.mexico = {
	"config": {
		"mapWidth": 792.41846,
		"mapHeight": 497.54324,
		"defaultText": describe["pais"]
	},
	"paths": [
		{
			"enable": true,
	...
	"pins": [
		{
			...
			"selectedColor": select_color,
			"url": "http://jsmaps.io",
			"text": "<h1>Guadalajara</h1><br /><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>"
		}
	]*/
}
